...
// openArchiveFile override (no real .big I/O). A future edit that drops or inverts the
// retailScan argument at a call site now fails this test instead of silently mis-mounting.
